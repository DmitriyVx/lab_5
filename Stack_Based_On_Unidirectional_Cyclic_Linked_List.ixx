...
export module Dynamic_Structures: Stack_Based_On_Unidirectional_Cyclic_Linked_List;

import :Abstract_Class_Stack;
export namespace Dynamic_Structures
{
    template <typename T>
    class StackBasedOnUnidirectionalCyclicLinkedList : public AbstractClassStack<T> {
    private:
        template <typename T>
        class Node {
        public:
